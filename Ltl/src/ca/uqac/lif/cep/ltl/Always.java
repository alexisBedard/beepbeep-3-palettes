 ...
 */
public class Always extends UnaryOperator implements SMVInterface
{
	...
	printStream.printf("MODULE Always(lastReceived, inc_1, inb_1,ouc_1, oub_1, lastPassed) \n");
	printStream.printf("	ASSIGN \n");
		
	printStream.printf("		init(ouc_1) := case \n");
	printStream.printf("			inc_1 = 0 : 0; \n");
	printStream.printf("			TRUE: 2; \n");
	printStream.printf("		esac; \n");
	printStream.printf("\n");
	printStream.printf("		init(oub_1) := case \n");
	printStream.printf("			inb_1 = TRUE : TRUE; \n");
	printStream.printf("			(ouc_1 = 0) & next(inb_1) : TRUE; \n");
	printStream.printf("			(ouc_1 = 0) & next(!inb_1) : FALSE; \n");
	printStream.printf("			TRUE : FALSE; \n");
	printStream.printf("		esac; \n");
	printStream.printf("\n");
	printStream.printf("		next(ouc_1):= case \n");
	printStream.printf("			next(inc_1) = 0   : 0; \n");	
	printStream.printf("			oub_1 : 0; \n");
	printStream.printf("			TRUE : 2; \n");
	printStream.printf("		esac; \n");
	printStream.printf("\n");
